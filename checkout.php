...
<body>
	...
	<div class="main">
		<div class="shop_top">
			<div class="container">
				<h4 class="title">Carrito de compras vacío.</h4>
				<p class="cart">No tienes ningún producto agregado has <br>click<a href="index.html">aquí</a> para
					comenzar a comprar</p>
			</div>
		</div>
	</div>
	<div class="footer">
